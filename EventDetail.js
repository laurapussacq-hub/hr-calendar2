    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-box" onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ padding: '28px 28px 24px' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 24, margin: '0 0 8px', color: 'var(--ink)', lineHeight: 1.2 }}>
            {event.titulo}
          </h2>
          <p style={{ color: 'var(--ink-muted)', fontSize: 14, margin: '0 0 16px', textTransform: 'capitalize' }}>
            📅 {fecha}
          </p>
          {event.descripcion && (
